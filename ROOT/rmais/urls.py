...
urlpatterns = patterns('',
	...
	url(r'^dashboard/admin/usuarios/add/post/(?P<status>\d+)/(?P<qtd_dias>\d+)/$', views.usuarioAddPost, name='usuarioAddPost'),    
	...
	url(r'^dashboard/admin/noticias/duplicar/(?P<id>[a-zA-Z0-9_.-]+)/$', views.duplicar_noticia, name='duplicar_noticia'),  
	...
	url(r'^dashboard/configuracoes/$', views.configuracoes, name='configuracoes'),
	url(r'^dashboard/configuracoesPost/$', views.configuracoesPost, name='configuracoesPost'),
	url(r'^info/(?P<page>[a-zA-Z0-9_.-]+)/$', views.pagina, name="pagina"),
	# url(r'^busca/(?P<buscar>[a-zA-Z0-9_.-]+)/$', views.rbusca, name='rbusca'), 
	url(r'^busca/$', views.rbusca, name='rbusca'),
	url(r'^busca-export/$', views.rbusca_export, name='rbusca_export'), 
	url(r'^esqueci-minha-senha/$', views.email, name='email'), 
	url(r'^(?P<slug>[a-zA-Z0-9_.-]+)/$', views.listagem, name="listagem"),
	url(r'^listagem-infinita/noticias-json/(?P<categoria_slug>[a-zA-Z0-9_.-]+)/page/(?P<pagina>[a-zA-Z0-9_.-]+)/$', views.noticia_listagem_paginacao_infinita_json, name="noticia_listagem_paginacao_infinita_json"),
	# url(r'^listagem-infinita/noticias-json/(?P<categoria_slug>[a-zA-Z0-9_.-]+)/page/(?P<pagina>[a-zA-Z0-9_.-]+)/$', views.noticia_listagem_paginacao_infinita_json, name="noticia_listagem_paginacao_infinita_json"),
	url(r'^(?P<categoria>[a-zA-Z0-9_.-]+)/(?P<id>[a-zA-Z0-9_.-]+)/(?P<slug>[a-zA-Z0-9_.-]+)/$', views.noticia, name="noticia"),
)