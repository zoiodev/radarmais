...
class Usuario(models.Model):
	...
	status = models.IntegerField(choices=options, null=True, blank=True)
	temp_day = (
		(0, 'Ilimitada'),
		(1, '7 Dias'),
		(2, '15 Dias'),
	...
	dias_liberado = models.IntegerField(choices=temp_day, default=0, blank=True, null=True)
	delete = models.BooleanField(default=0)
	data_criacao = models.DateTimeField(auto_now_add=True, blank=True)
	primeiro_acesso = models.BooleanField(default=1)
