...
class Categoria(models.Model):
	...
	slug = models.SlugField(max_length=100, verbose_name=u'Url Amigavel')
	...
	def __unicode__(self):
		return unicode(self.nome_da_categoria)
...
class Empresa(models.Model):
	...
	def __unicode__(self):
		return unicode(self.nome_da_empresa)
...
class Noticia(models.Model):
	...
	data_da_noticia = models.DateTimeField('Data da Noticia', null=True, blank=True)
	ativo = models.BooleanField(default=1)
	...
	class Meta(object):
		ordering = ['-data_de_publicacao', '-data_criacao']
...
class Represa(models.Model):
	...
	def __unicode__(self):
		return unicode(self.nome_da_represa)
...
class NivelDaAgua(models.Model):
	...
	def __unicode__(self):
		return unicode(self.nivel_da_agua)

class Pagina(models.Model):
	titulo = models.CharField(max_length=100)
	slug = models.SlugField(max_length=100, verbose_name=u'Url Amigavel', unique=True)
