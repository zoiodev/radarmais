...
$(function () {
	$('.editable').mediumInsert({
		...
		addons: {
			images: {
				uploadScript: '/dashboard/admin/upload-files/', // (string) A relative path to an upload script
				deleteScript: '/dashboard/admin/delete-files/', // (string) A relative path to a delete script
